                        ...
                        <div class="left_col scroll-view">
                            ...
                            <div class="profile clearfix">
                                ...
                                <div class="profile_info">
                                    <span>Bem vindo, </span>
                                    <h2><?php echo $this->session->userdata['nome_usuario'];?></h2>
                                </div>
                            </div>
                            <!-- /menu profile quick info -->
                            ...
                            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                                <div class="menu_section">
                                    ...
                                    <ul class="nav side-menu">
                                        <?php 
                                        foreach (@$this->session->userdata['menu'] as $m){ ?>
                                            <li><a><i class="<?php echo $m['miniatura']; ?>"></i> <?php echo $m['nome']; ?> <span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu">
                                                <?php foreach(@$this->session->userdata['funcionalidades'] as $f){
...
<!--                    <footer>
                        <div class="pull-right">
                            Avicultura de Postura IF Sul de Minas Campus Muzambinho
                        </div>
                        <div class="clearfix"></div>
                    </footer>-->
                    <!-- /footer content -->
...
<script type="text/javascript">
clickHeatSite = 'localhost.avicultura';
clickHeatGroup = encodeURIComponent(window.location.pathname+window.location.search);
clickHeatServer = 'http://localhost/avicultura/clickheat/click.php';
initClickHeat(); //
</script>-->

<!--        <script type="text/javascript" src="http://localhost/sinasefe_sistema/clickheat/js/clickheat.js"></script>
        <noscript><p><a href="http://www.dugwood.com/index.html">Heatmap plugin</a></p></noscript>
        <script type="text/javascript">
            clickHeatSite = 'localhost.sinasefe_sistema';
            clickHeatGroup = encodeURIComponent(window.location.pathname+window.location.search);
            clickHeatServer = 'http://localhost/sinasefe_sistema/clickheat/click.php';
            initClickHeat(); //
        </script>-->
    <?php
    //<-- jQuery -->
