...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color:#F3EFF5 !important; border-bottom: solid #454955 1px !important;">
            <div id="logo" class="navbar-brand navlinksB"> <img class="logo" src="<?php echo base_url('template/assets/img/logo.svg'); ?>"> <span class="textlogo"> SEARCH UP </span> </div>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul id="ulnav" class="navbar-nav navlinksB mx-auto">
                    <li  class="nav-item">
